...
export namespace Prisma {
  ...
  */
    ...
    model: {
      ...
      Progresso: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.ProgressoFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.ProgressoAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type ProgressoOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "usuario" | "fase" | "pontuacao" | "criadoEm", ExtArgs["result"]["progresso"]>
  ...
  export interface ProgressoDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more Progressos that matches the filter.
     * @param {ProgressoFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const progresso = await prisma.progresso.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: ProgressoFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a Progresso.
     * @param {ProgressoAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const progresso = await prisma.progresso.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
     * })
     */
    aggregateRaw(args?: ProgressoAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  interface ProgressoFieldRefs {
    ...
    readonly usuario: FieldRef<"Progresso", 'String'>
    readonly fase: FieldRef<"Progresso", 'Int'>
    readonly pontuacao: FieldRef<"Progresso", 'Int'>
   ...
   * Progresso findRaw
   */
  export type ProgressoFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
  ...
  /**
   * Progresso aggregateRaw
   */
  export type ProgressoAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export type ProgressoWhereInput = {
    ...
    usuario?: StringFilter<"Progresso"> | string
    fase?: IntFilter<"Progresso"> | number
    pontuacao?: IntFilter<"Progresso"> | number
  ...
  export type ProgressoScalarWhereWithAggregatesInput = {
    ...
    usuario?: StringWithAggregatesFilter<"Progresso"> | string
    fase?: IntWithAggregatesFilter<"Progresso"> | number
    pontuacao?: IntWithAggregatesFilter<"Progresso"> | number
